...
# run program.
./${TARGET} "192.168.1.2" "12000" ${DESP_ALIAS} ${DESP_PROTOCOL}  # for simple run program
#${GDB_BIN} ./${TARGET}  ${GDB_FILE}        # for gdb debug
#${VAL_BIN} ${VAL_OPT} ./${TARGET} "192.168.1.2" "12000" ${DESP_ALIAS} ${DESP_PROTOCOL} >& ${VAL_FILE} # for valgrind debug
